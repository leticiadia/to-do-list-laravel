        ...
        <form action="{{ route('tasks.search') }}" method="get">
            <div class="flex justify-center items-center">
                <div class="mb-3 xl:w-96">
                    <div class="input-group relative flex items-stretch w-full mb-4 px-8">
                        <input type="search" name="query" placeholder="Find your task" value="{{ request('search') }}" class="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-violet-600 focus:outline-none" aria-label="Search" aria-describedby="button-addon2">
